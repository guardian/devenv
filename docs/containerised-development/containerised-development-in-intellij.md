...
5. Choose "Create Dev container and Clone Sources"

IntelliJ will now create a dev container based on the definition file in the local source, but fetch the application source inside the container from git. At this point you can delete the original checkout.

...
sudo chown -RL "$DEVENV_CONTAINER_USER":"$DEVENV_CONTAINER_USER" "$DEVENV_IVY_USER_DIR"
...
sudo chown -RL "$DEVENV_CONTAINER_USER":"$DEVENV_CONTAINER_USER" "$DEVENV_COURSIER_USER_DIR"
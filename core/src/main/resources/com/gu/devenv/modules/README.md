...
The `postCreateCommand` hook ends with a "Setup complete" message, so engineers know all one-off
setup commands have finished and the container is ready to open in an IDE.
